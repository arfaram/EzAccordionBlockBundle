 ...
 * @version //autogentag//
 *
 * Execute with: php app/console ezpublish:cookbook:create_content_type accordion Content
 */
namespace EzAccordionBlockBundle\Command;
...
class CreateContentTypeCommand extends ContainerAwareCommand
{
    ...
    protected function execute( InputInterface $input, OutputInterface $output )
    {
        ...
        $contentTypeCreateStruct->descriptions = array(
            'eng-GB' => 'Description for ' . $contentTypeIdentifier ,
        ...
        // add a ezrichtext Field body field
